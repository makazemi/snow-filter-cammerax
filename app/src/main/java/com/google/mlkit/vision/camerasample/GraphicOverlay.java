...
public class GraphicOverlay extends View {
  ...
  // Base class for a custom graphics object to be rendered within the graphic overlay. Subclass
   ...
   // instances to the overlay using {@link com.google.mlkit.vision.GraphicOverlay#add(Graphic)}.
  ...
  public abstract static class Graphic {
    ...
    public float getScaleFactor(){ return overlay.scaleFactor;}
  }
  ...
  private void initProcessCanvas () {
    processBitmap = Bitmap.createBitmap(getMeasuredWidth(), getMeasuredHeight(), Bitmap.Config.ARGB_8888);
