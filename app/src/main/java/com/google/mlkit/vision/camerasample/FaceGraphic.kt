 ...
 */
class FaceGraphic constructor(overlay: GraphicOverlay?, private val face: Face,private val resource:Resources) : GraphicOverlay.Graphic(overlay) {
  ...
  private val labelPaints = Array(numColors) { Paint() }
      ...
      private val glassesBitmap = BitmapFactory.decodeResource(resource, R.drawable.glasses)

    // The cigarette bitmap
    private val cigaretteBitmap = BitmapFactory.decodeResource(resource, R.drawable.cigarette)
  ...
  override fun draw(canvas: Canvas) {
    ...
    Log.d(TAG,"left eay=$leftEye")
    if (face.leftEyeOpenProbability != null) {
      Log.d(TAG,"face.leftEyeOpenProbability != null")
      canvas.drawText(
...
//      )
  ...
  private fun drawFaceLandmark(canvas: Canvas, @LandmarkType landmarkType: Int) {
    ...
    if (faceLandmark != null) {
      Log.d(TAG,"drawFaceLandmark=$faceLandmark")
      canvas.drawCircle(
